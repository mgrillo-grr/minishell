...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/17 13:21:01 by mdios-el          #+#    #+#             */
/*   Updated: 2025/07/17 13:21:02 by mdios-el         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	execute_command(t_data *data, t_command *cmd)
{
	...
	if (!cmd || !cmd->command)
		exit_shell(data, errmsg_cmd(MSG_CHILD, NULL,
				E_NO_CMD_TO_EXEC, EXIT_FAILURE));
