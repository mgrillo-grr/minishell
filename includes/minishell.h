...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/17 13:17:23 by mdios-el          #+#    #+#             */
/*   Updated: 2025/07/17 13:17:53 by mdios-el         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define E_OLDPWD_NOT_SET "OLDPWD not set"
# define E_COMMAND_NOT_FOUND "command not found"
# define E_IS_A_DIRECTORY "Is a directory"
# define E_AMBIGUOUS_REDIRECT "ambiguous redirect"
# define E_UNEXPECTED_ERROR "an unexpected error occured"
# define E_INIT_ENV "Could not initialize environment"
# define E_INIT_WDS "Could not initialize working directories"
# define E_NO_CMD_TO_EXEC "parsing error: no command to execute!"
# define E_UNEXPECTED_EOF_MATCHING "unexpected EOF while looking for matching"
# define E_SYNTAX_ERROR "syntax error"
# define E_SYNTAX_ERROR_NEAR "syntax error near unexpected token"
# define E_UNEXPECTED_EOF "unexpected end of file"
# define E_HEREDOC_EOF \
	"here-document delimited by end-of-file: wanted"
# define E_CD_ERROR_RETRIEVING \
	"cd: error retrieving current directory"
# define E_GETCWD_CANNOT_ACCESS \
...
# define MSG_EXECVE "execve"
# define MSG_FORK "fork"
# define MSG_DUP "dup"
# define MSG_DUP2 "dup2"
